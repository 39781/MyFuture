module.exports = {	
	...
	html:"<html><head><meta charset='utf-8'><meta http-equiv='X-UA-Compatible' content='IE=edge,chrome=1'><meta name='viewport' content='width=device-width'><title> Collapsable example </title><link rel='stylesheet' href='./public/Treant.css'><link rel='stylesheet' href='./public/collapsable/collapsable.css'><link rel='stylesheet' href='./public/vendor/perfect-scrollbar/perfect-scrollbar.css'></head><body><div class='chart' id='collapsable-example'></div><script src='./public/vendor/raphael.js'></script><script src='./public/Treant.js'></script><script src='./public/vendor/jquery.min.js'></script><script src='./public/vendor/jquery.easing.js'></script><script>configJson;tree = new Treant(careerConfig);</script></body></html>",	
}
